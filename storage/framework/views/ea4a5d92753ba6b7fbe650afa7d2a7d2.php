...
async function loadProduk() {
    const res = await fetch('<?php echo e(route("api.produk.list")); ?>');
...
function konfirmasiPesanan() {
    ...
    Swal.fire({
        ...
        window.location.href = "<?php echo e(route('pembayaran')); ?>";
    });
}
...
</html><?php /**PATH C:\xamppbaruu\htdocs\laravel\resources\views/index.blade.php ENDPATH**/ ?>