    ...
    <div class="table-container">
        <table style="width: 100%;">
            ...
            <tbody id="produkTableBody">
                ...
                <tr class="table-row" data-id="<?php echo e($produk->id); ?>">
                    <td style="text-align: center; font-weight: bold;"><?php echo e($no++); ?></td>
                    <td class="nama-cell"><?php echo e($produk->nama); ?></td>
                    <td class="kategori-cell"><?php echo e($produk->kategori); ?></td>
                    <td class="harga-cell">Rp<?php echo e(number_format($produk->harga,0,',','.')); ?></td>
                    <td class="stok-cell"><?php echo e($produk->stok); ?></td>
                    <td class="gambar-cell">
                        <?php if($produk->gambar): ?>
                            <img src="<?php echo e(asset($produk->gambar)); ?>" class="product-image">
                        <?php else: ?>
                    ...
                    <td>
                        <button onclick="editProduk(
                            ...
                            '<?php echo e(addslashes($produk->kategori)); ?>',
                            '<?php echo e($produk->harga); ?>',
                            '<?php echo e($produk->stok); ?>',
                            '<?php echo e(addslashes($produk->deskripsi ?? '')); ?>',
                            '<?php echo e(addslashes($produk->bahan ?? '')); ?>'
                        )" class="btn-edit">
                            <i class="bi bi-pencil"></i> Edit
                        </button>
                        <button onclick="hapusProduk(<?php echo e($produk->id); ?>)" class="btn-delete">
...
document.getElementById('tambahProdukForm').addEventListener('submit', function(e) {
    ...
    fetch('<?php echo e(route("produk.store")); ?>', {
        method: 'POST',
        headers: {
...
</html><?php /**PATH C:\xamppbaruu\htdocs\laravel\resources\views/admin/kelola_produk.blade.php ENDPATH**/ ?>