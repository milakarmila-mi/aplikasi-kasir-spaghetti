...
onclick="editKasir('{{ $k->id }}','{{ $k->username }}','{{ $k->password }}')">
<i class="bi bi-pencil"></i> Edit
</button>

<a href="{{ route('kasir.hapus',$k->id) }}"
...
<form method="POST" action="{{ route('kasir.simpan') }}" class="modal-content">
@csrf
